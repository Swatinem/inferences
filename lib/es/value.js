...
ObjectValue.prototype.Put = function ObjectValue_Put(P, V, Throw) {
	if (!this.CanPut(P)) {
		// TODO: TypeError
...
// 8.12.9
ObjectValue.prototype.DefineOwnProperty = function ObjectValue_DefineOwnProperty(P, Desc, Throw) {
	// TODO: Reject
