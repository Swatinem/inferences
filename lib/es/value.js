...
// 8.12.7
ObjectValue.prototype.Delete = function ObjectValue_Delete(runtime, P, Throw) {
	var desc = this.GetOwnProperty(P);
	if (!desc) {
		return [runtime, true];
	}
	if (desc.Configurable) {
		var cowed = runtime.cow(this.properties);
		cowed[1].delete(P); // properties
