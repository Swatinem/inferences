		...
		case 'UnaryExpression':
			switch (ast.operator) {
				...
				case 'delete':
					...
					if (runtime.IsPropertyReference(ref)) {
						var ret = runtime.ToObject(ref.base).Delete(runtime, ref.name, ref.strict);
						cowRuntime(ret[0]);
						return new runtime.BooleanValue(ret[1]);
					} else {
						// TODO: 5.a strict: throw SyntaxError
						var bindings = ref.base;
						var ret = bindings.DeleteBinding(runtime, ref.name);
						cowRuntime(ret[0]);
						return new runtime.BooleanValue(ret[1]);
					}
